...
const unsigned char table_lc[]= //???¡À?,???38??,??????24 
{
...
#define KEY_SET          0x01//0b00000001             // key1 ???¨¹?  
...
unsigned char r_key;//???????????????????????
unsigned char r_keyz;//?§Ñ????????????????????
unsigned char r_sfkeyz;//?›¥???????
unsigned char t_write_e2;//???§ÕE2???
unsigned char r_lcad;
unsigned char r_lcXsad;//????????????ad?
unsigned char r_set_state;//????????????????
unsigned char r_flash_bit;//?????¦Ë??
...
unsigned char r_buzz;//???????????§Ö????,????5??????;0,2,4??100ms;1,3?50ms
unsigned char t_buzz;//????????????
unsigned char u8_test_alarm_count;
unsigned char u8_test_alarm_time;

unsigned char r_lczt;//????Ú…???
unsigned char r_lcztCopy;
unsigned char r_lcztx;
unsigned char r_ldzt;//???Ú…???,???200 ????????????§Ö???????
unsigned char r_ldztCopy;

unsigned char r_bwtj;//?Ú…??????¦Ë
unsigned char r_swtj;//?Ú…????¦Ë??
unsigned char r_gwtj;//?Ú…????¦Ë??
...
unsigned char u8_ld_bjycsj;//????????????,§³?
unsigned char u8_ld_bjycsjx;
unsigned char u8_lc_bjycsj;//????????????,§³?
...
unsigned char r_ldwdjz;	//?????§µ?,???10
unsigned char r_ldwdjzx;//??§µ????,???10
unsigned char r_ld_high_alarm;//?????¡À????Ú…????
unsigned char r_ld_high_alarmCopy;
unsigned char r_ld_low_alarm;//?????¡À????Ú…????
unsigned char r_ld_low_alarmCopy;
unsigned char r_lc_high_alarm;//?????¡À????Ú…????
unsigned char r_lc_high_alarmCopy;
unsigned char r_lc_low_alarm; //?????¡À????Ú…????
...
unsigned char r_lcwdjz;//?????????§µ??
unsigned char r_lcwdjzx;
unsigned char r_lcxswdjz;//?????????§µ??
...
unsigned char f_deHum_and_lcTemp;//??????????0???????????1???????????4???? 2????§³??4????
...
uchar    ACKok;
uchar f8_lcCompAddUp6HourProtect;               // 140819 6§³???? 
uint  u16_lcComp_Addup_Minute;                  // ??????
uchar u8_lcCompAddUp6HourProtectTimer;          // ??????? 
uchar f8_lcCompAddUp6HourTimer;                 // 141017 ???6§³???? 
